...
%\onehalfspacing
\title{ESTUDO DE VIABILIDADE E PROPOSTA DE TOPOLOGIA DE UM SISTEMA DE GERENCIAMENTO DE ENERGIA PARA NANOSATÉLITES DA CONSTELAÇÃO ALFA CRUX}
\author{Hugo Nascimento Fonseca}
\date{2020-12-11} %data da defesa

\grau{Bacharel} %Mestre ou Doutor
...
\totalpgs{47} %total de páginas atualmente na sua dissertação
\dia{11} %dia da defesa
...
\titulolinhai{ESTUDO DE VIABILIDADE E PROPOSTA}
\titulolinhaii{DE TOPOLOGIA DE UM SISTEMA DE}
\titulolinhaiii{GERENCIAMENTO DE ENERGIA PARA}
\titulolinhaiv{NANOSATÉLITES DA CONSTELAÇÃO ALFA CRUX}
...
\membrodabancaii{Prof. Dr. Renato Alves Borges, ENE/UnB}
\membrodabancaiifuncao{Examinador interno}
\membrodabancaiii{Prof. Dr. José Edil Guimarães de Medeiros, ENE/UnB}
